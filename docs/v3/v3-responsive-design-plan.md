...
8. Update Product Detail with grouped detail sections.
9. Update Fields Settings to match the current card-based page structure.
10. Run `node v3/verify-v3.mjs` again and confirm it passes.
11. Open or inspect the page for visual sanity in PC-first full-page mode.
